  ...
  return (
    <div >
        <div className='top-div'>
          ...
          <h1 className='welcome-text'>Welcome to techy</h1>
            <p className='desctiption-text'>the simplest way to manage your Academy</p>
              <p className='caption-text'>track you students progress and manage your courses
            <span class="line-break"> mentors, opportunities all in one platform.</span></p>
          </div>
        </div>
        <div className='container'>
          ...
          <div className='username-container'>
          <label htmlFor="username-input" className="username-label">Password:</label>
