    ...
    <div>
      ...
      <div className="main-container">
        <div className="menu-container">
          ...
          <div className="menu">
            <button
              className={`mr-4 ${selectedOption === "option1" ? "selected" : ""}`}
              onClick={() => handleMenuChoice("option1")}
            >
              Role details
            </button>
            <button
              className={`mr-4 ${selectedOption === "option2" ? "selected" : ""}`}
...
const getContent = (choice, currentPage, setCurrentPage, totalPages) => {
  const users = [
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Draft" },
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Active" },
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Disabled" },
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Draft" },
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Active" },
    { name: "Ahmed Mealy", email: "ahmed@gmail.com", mobile: "+2011424532845", gender: "Male", status: "Draft" },
  ];
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border-collapse">
              <thead className="bg-blue-50">
                <tr>
                  <th className="px-4 py-2 text-gray-700 text-center">Privileges</th>
                  ...
                  <th className="px-4 py-2 text-gray-700 text-center">Export</th>
                </tr>
              </thead>
              <tbody>
                {["Courses", "Students", "Mentors", "Coupons", "Payment methods", "Jobs"].map(
                  (privilege, index) => (
                    <tr key={index} className={`${index % 2 === 0 ? "bg-gray-50" : ""}`}>
                      <td className="px-4 py-2 text-gray-700 text-center border">{privilege}</td>
