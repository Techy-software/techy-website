              ...
              {courseData?.sectionDetails?.length > 0 ? (
                [...courseData.sectionDetails]
                  ...
                  .map((section, sectionIndex) => (
                    <ul key={sectionIndex} className="unit-list mt-2 space-y-2">
                      <li className="unit-item border rounded-md p-3">
                        ...
                        >
                          {section.title || `Unit ${sectionIndex + 1}`}
                        </div>
                        {expandedSection === sectionIndex && (
                          <div className="ml-4 mt-2 space-y-2">
                            ...
                            <button
                              ...
                              onClick={() => {
                                setActiveSectionForLesson(sectionIndex);
      ...
      {showLessonModal && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <div className="text-gray-500 italic">Lesson form goes here...</div>
